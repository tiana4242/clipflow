...
export const PWAInstallPrompt: React.FC<PWAInstallPromptProps> = ({
  ...
  // Show floating prompt (auto-popup)
  if (show) {
    return (
  ...
  if (showButton) {
    return (
      <button
        onClick={onInstall}
        className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-purple-700 hover:to-blue-700 transition-colors flex items-center gap-2"
      >
        <Download className="w-4 h-4" />
        Install App
      </button>
